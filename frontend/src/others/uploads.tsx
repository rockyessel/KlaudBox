...
const Upload = () => {
  ...
  return (
    <main className='w-full h-screen px-3 md:px-6 lg:px-20 xl:px-60 py-10 bg-zinc-800 flex flex-col gap-5'>
      <section className='bg-zinc-900 p-10 rounded-md'>
        <div>
      ...
      <section className='w-full bg-zinc-900 p-10 flex flex-col gap-10'>
